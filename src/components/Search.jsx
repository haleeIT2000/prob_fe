  ...
  return (
      <form className="border-b border-slate-200">
            <div className="relative">
              ...
              <input onChange={(e) => onChangeSearch(e.target.value)} className="w-full border-0 focus:ring-transparent placeholder-slate-400 
              appearance-none pl-10 pr-4 text-sm" type="search" placeholder="Tìm kiếm…" />
