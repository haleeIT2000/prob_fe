        ...
        <div ref={modalContent} className="bg-white overflow-auto max-w-2xl w-full max-h-full rounded shadow-lg">
          ...
          <form className="border-b border-slate-200">
            <div className="relative">
              ...
              <input id={searchId} className="w-full border-0 focus:ring-transparent placeholder-slate-400 appearance-none py-3 pl-10 pr-4" type="search" placeholder="Tìm kiếm…" ref={searchInput} />
